...
import SectionSorting from "../pages/LocationManagement/Cities/SectionSorting";
...
import RegisteredCustomers from "../pages/tickyourlist/AdminOps/RegisteredCustomers";
import LiveCustomerActivity from "../pages/tickyourlist/AdminOps/LiveCustomerActivity";
...
const authProtectedRoutes = [
  ...
  { path: "/admin-ops/registered-customers", component: <GlobaltixAuthGuard><RegisteredCustomers /></GlobaltixAuthGuard> },
  { path: "/admin-ops/live-customer-activity", component: <GlobaltixAuthGuard><LiveCustomerActivity /></GlobaltixAuthGuard> },
