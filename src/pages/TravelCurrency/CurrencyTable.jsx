...
const CurrencyTable = () => {
  ...
  <div className="currency-header-bar">
    <div>
      ...
      <p className="currency-page-route">Dashboard / Travel Currency</p>
    </div>
      ...
      <table className="currency-table">
        <thead>
          ...
          <tr className="search-row">
            <th><input type="text" value={searchName} onChange={(e) => setSearchName(e.target.value)} placeholder="Search..." /></th>
            <th><input type="text" value={searchCode} onChange={(e) => setSearchCode(e.target.value)} placeholder="Search..." /></th>
            <th><input type="text" value={searchSymbol} onChange={(e) => setSearchSymbol(e.target.value)} placeholder="Search..." /></th>
            <th>
